...
STAT_RULES = [
    ("three_point_volume", "base", "FG3A", True,
     "Team ranks in the {pct:.0f}th percentile for three-point attempts per game", None),
    ("defense_overall", "advanced", "DEF_RATING", False,
     "Defensive rating is in the {pct:.0f}th percentile (higher = worse defense)", None),
    ("offense_overall", "advanced", "OFF_RATING", True,
     "Offensive rating is in the {pct:.0f}th percentile", None),
    ("defensive_rebounding", "advanced", "DREB_PCT", True,
     "Defensive rebound share is in the {pct:.0f}th percentile", None),
    ("playmaking", "advanced", "AST_PCT", True,
     "Share of baskets assisted is in the {pct:.0f}th percentile", None),
    ("ball_security", "advanced", "TM_TOV_PCT", False,
     "Turnover rate is in the {pct:.0f}th percentile (higher = more turnovers)", None),
    ("rim_protection", "base", "BLK", True,
     "Blocks per game is in the {pct:.0f}th percentile", "blocks are a partial proxy for rim protection"),
    ("point_of_attack_defense", "base", "STL", True,
     "Steals per game is in the {pct:.0f}th percentile", "steals are a partial proxy for point-of-attack pressure"),
    ("shooting_efficiency", "advanced", "TS_PCT", True,
     "True-shooting percentage is in the {pct:.0f}th percentile", None),
]
